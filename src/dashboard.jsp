...
<%
String urlHostName = PropsUtil.get("openqms.installation.hostname");
String urlProtocol = PropsUtil.get("openqms.installation.protocol");
String urlPort = PropsUtil.get("openqms.installation.portnumber");
		...
		<li class="<%= classs %>"><a <%= other_class %> <%= rootHref %>>
			...
			<ul class="dropdown-menu pull-left firstLevelMenuQMS">
                ...
                %>  
                 ...
                 <script>
                    document.getElementById("form-analytics").action = 'https://' + "alfapbe.momentumsystems.com.au" +":443/";
